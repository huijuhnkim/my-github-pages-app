...
const Portfolio: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: 'This is a placeholder project to demonstrate the 3-column grid layout. It showcases how multiple projects align in the portfolio grid system.',
      thumbnail: 'https://via.placeholder.com/400x300/e5e5e5/666666?text=Project+3',
      tags: ['Music Production', 'Product Design'],
      fullDescription: 'Full description for placeholder project 3.',
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <header className="mb-48">
                <div className="grid grid-cols-3 gap-8">
                  {/* Left Column - Name and Profile Picture (1/3 width) */}
                  <div className="col-span-1">
                    <h1 className="text-3xl font-bold text-gray-800 mb-4" style={{ fontFamily: 'Inter, sans-serif' }}>Hugh Kim</h1>
                  ...
                  {/* Right Column - Links and Summary (2/3 width) */}
                  <div className="col-span-2 flex flex-col pt-14">
              ...
              {/* Middle Section - Tags and Search Bar */}
              <div className="mb-12">
                <div className="grid grid-cols-3 gap-8">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {tags.map(tag => (
                          <button
                              ...
                              className="px-3 py-1 rounded-full text-xs font-medium text-white transition-all duration-200 transform hover:scale-105"
                              style={{
              ...
              {/* Bottom Section - Projects Grid (3 columns) */}
